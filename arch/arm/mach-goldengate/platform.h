...
/* peripheral */
#define GOLDENGATE_GLOBAL_BASE		0xF0000000	/* GLOBAL_JTAG_ID */

#define GOLDENGATE_NIMAC_BASE		0xF0010000	/* = NI_TOP_NI_INTF_RST_CONFIG */
#define GOLDENGATE_FE_TOP_BASE		0xF0020000	/* FETOP_FE_SCRATCH */
#define GOLDENGATE_QM_TOP_BASE		0xF0030000	/* QM_CONFIG_0 */
#define GOLDENGATE_TM_TOP_BASE		0xF0040000	/* TM_BM_CONFIG_0 */

#define GOLDENGATE_FLASH_CTRL_BASE	0xF0050000	/* = FLASH_ID */  /* Flash Controller */

#define GOLDENGATE_SCH_BASE		0xF0060000	/* SCH_CONTROL */

#define GOLDENGATE_REGBUS_BASE		0xF0070004	/* PER_PERIPHERAL_INTERRUPT_0 */
#define GOLDENGATE_TIME0_BASE		0xF007001C	/* PER_TMR_LD1 */
#define GOLDENGATE_TIME1_BASE		0xF007003C	/* PER_TMR_LD2 */
#define GOLDENGATE_SPI_BASE		0xF0070064	/* PER_SPI_CLK */
#define GOLDENGATE_MDIO_BASE		0xF00700A0	/* PER_MDIO_CFG */
#define GOLDENGATE_BIW_BASE		0xF00700E8	/* PER_BIW_CFG */
#define GOLDENGATE_UART0_BASE		0xF0070110	/* PER_UART0_CFG */
#define GOLDENGATE_UART1_BASE		0xF0070140	/* PER_UART1_CFG */
#define GOLDENGATE_GPIO0_BASE		0xF00701D0	/* PER_GPIO0_CFG */
#define GOLDENGATE_GPIO1_BASE		0xF00701F0	/* PER_GPIO1_CFG */
#define GOLDENGATE_GPIO2_BASE		0xF0070210	/* PER_GPIO2_CFG */
#define GOLDENGATE_GPIO3_BASE		0xF0070230	/* PER_GPIO3_CFG */
#define GOLDENGATE_GPIO4_BASE		0xF0070250	/* PER_GPIO4_CFG */

#define GOLDENGATE_TS_BASE		0xF0080000	/* TS_T_DMA_RXDMA_CONTROL */

#define GOLDENGATE_DMA_BASE		0xF0090000	/* = DMA_DMA_LSO_RXDMA_CONTROL */
#define GOLDENGATE_DMA_LSO_BASE		GOLDENGATE_DMA_BASE
#define GOLDENGATE_DMA_SSP_BASE		0xF0090400	/* DMA_DMA_SSP_RXDMA_CONTROL */
#define GOLDENGATE_SSP0_BASE		0xF0090700	/* DMA_SSP_ID */
...
#define GOLDENGATE_TRNG_BASE		0xF0600000	/* = TRNG_CNTL */
...
#define GOLDENGATE_CLCD_BASE		GOLDENGATE_LCDC_BASE

#define GOLDENGATE_RTC_BASE		0xF4920000	/* RTC_RTCON */
#define GOLDENGATE_CIR_BASE		0xF4921000	/* CIR_PWRCTRL_CIR_ID */
#define GOLDENGATE_POWERC_BASE		0xF4921024	/* CIR_PWRCTRL_PWR_CTRL0 */
#define GOLDENGATE_SPDIF_BASE		0xF4927000	/* SPDIF_DATA */
